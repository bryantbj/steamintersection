defmodule SteamIntersectionWeb.RoomLiveTest do
  use SteamIntersectionWeb.ConnCase

  import Phoenix.LiveViewTest
  import SteamIntersection.RoomsFixtures

  @create_attrs %{public_id: "some public_id"}
  @update_attrs %{public_id: "some updated public_id"}
  ...
  describe "Index" do
    ...
    test "updates room in listing", %{conn: conn, room: room} do
      ...
      assert html =~ "some updated public_id"
    end
